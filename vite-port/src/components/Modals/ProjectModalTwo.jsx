      ...
      <div onClick={onClose} className={`${open ? 'overlay-modal' : ''} over-menu`}></div>
            <div className='modal'>
              <div title='Scroll down to see more' className='banner'>
                ...
                <div className='more'>
                  <a title='View Website live' href='https://traveliy.netlify.app' target='blank' className='more-icon'>
              ...
              <div className='body'>
                <div className='heading'>
                  ...
                  <span>What I used :</span>
                    ...
                    <img title='Tailwind Css' className='tool-img' src={TailwindLogo} alt="" />
